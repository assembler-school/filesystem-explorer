...
array_walk($folders, function ($path) {
  ...
  echo "<a href='index.php?path=$path' class='m-0 folderLink' title='$folderName'><div class='folder d-flex flex-column justify-content-end m-2 p-1' title='$folderName'>
    $shortFolderName
