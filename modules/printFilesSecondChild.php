    ...
    while (false !== ($readFolder = readdir($openedFolder))) {
        ...
        if ($readFolder != "." && $readFolder != "..") {
            ...
            if($fileActualExt==false){
                array_push($arrayPrint, "<li data-path='$readFolder/' type='folder'><img class='folder-second-list-img' src='images/folderIconSmallx2.png' alt='folder'><span class='text-second-list'>$readFolder</span></li>");
            } else {
                ...
                if($fileActualExt==="png"){
                    array_push($arrayPrint, "<li data-path='$readFolder/' ><img class='folder-second-list-img' src='images/pngIcon.png' alt='folder'><span class='text-second-list'>$readFolder</span><span class='extesion-file'>$readFolderExt</span></li>");
                }
            }
        }
    }
