        ...
        foreach ($myFiles as $key => $element) {
            if (is_file("$path/$element")) {
                ...
                echo '<div class="col d-flex flex-column">
                            ...
                            <div id="nextTo">
                                        <svg class="trash-icon2" class="btn btn-primary" data-bs-toggle="modal" data-url="' . $path . "/" . $element . '" data-bs-target="#modalDelete" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16" style="cursor:pointer;">
