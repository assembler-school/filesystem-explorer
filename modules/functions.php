            ...
            if (is_file("$path/$element")) {
                ...
                echo '<div class="col d-flex flex-column">
                            ...
                            <div class="infoCard">
                                ...
                                <svg class="btn btn-primary trash-icon2" data-bs-toggle="modal" data-url="' . $path . "/" . $element . '" data-bs-target="#deleteItem" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
