...
<body class="bg-dark">
  <header class="p-3 text-white">
    <div class="container-fluid">
      <div class="d-flex flex-wrap align-items-center justify-content-between">
        <a href="<?= goRoot() ?>" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
  ...
  <nav class="navbar navbar-dark bg-secondary mx-4 rounded px-3">
    ...
    <div class="d-flex">
      <div>
        <a href="<?= goBack() ?>" class="btn btn-danger me-2"><i class="fad fa-arrow-alt-circle-left fa-2x"></i></a>
      </div>
