        ...
        <div class="row flex-nowrap">
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <a href="./index.php" class="d-flex align-items-center me-md-auto text-white text-decoration-none border border-info p-2 rounded-3 sideButtons mb-2">
                            ...
                            <ul class="collapse show nav flex-column ms-1" id="menu1" data-bs-parent="#menu">
                                <li class="w-100">
                                    ...
                                    <ul class="collapse show nav flex-column ms-1" id="sub1" data-bs-parent="#menu1">
                                        <li class="w-100">
                                            <a href="#" class="nav-link px-0 text-white"> <span class="d-none d-sm-inline">file</span> 1 </a>
                                        </li>
                                        <li>
                                            <a href="#" class="nav-link px-0 text-white"> <span class="d-none d-sm-inline">file</span> 2 </a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
