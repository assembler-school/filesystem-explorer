<!-- Details Modal -->
<div class='position-fixed vw-100 vh-100 bg-dark modal-shadow hidden' id='shadowDetails'></div>
<div class='modal-form modal-form-details position-fixed p-3 rounded bg-secondary hidden' id='formDetails'>
    ...
    <hr class='text-white' />
    <div class="ms-2" id="detailsContainer">
    </div>
</div>