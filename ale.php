...
<body>
  ...
  <main>
    <h3 class="title-files">ale <a href="/assembler_projects/php_module/filesystem-explorer/ale.php?name="><i class="fa-solid fa-rotate-left"></i></a></h3>
    <?php getFiles("./root/Imágenes/ale"); ?>
  </main>
